...
> Seedance 2.5 可使用用户的自然工作语言；中文提示词无需为追求效果而强制混入英文。运镜是决定视频质量的关键——同样的场景，精准运镜是"电影感"和"监控探头"的区别。
>
...
> 以下为 Seedance 2.5 可描述的特殊视觉效果，可与常规运镜自由组合使用；应补充物理变化与叙事目的，不把关键词当作绝对触发器。
