...
<p align="center">
  <a href=""><img src="https://img.shields.io/badge/version-2.0.0-blue.svg" alt="バージョン"></a>
...
| 機能 | 詳細 |
|------|------|
| 🎭 **演技レベルの微表情システム** | 顔の7領域パーツ語彙（目/眉/唇/鼻/顎喉/額/頬）＋ L1-L4の4段階表情強度体系 ＋ 2秒精度感情アーク編成（4パターン）＋ 12の感情アクター分解 ＋ 脱AIフェイク顔宣言 ＋ 微表情カメラワーク連携 |
...
### v2.0.0 (2026-07-23)
- 🎭 **演技レベルの微表情システム（新アーキテクチャ）**: `references/micro-expressions.md` 知識ベース（~400行）を新規導入。ドラマや高要求ショットにおける顔表情のクオリティを大幅向上、AI特有の不自然な顔や過度な誇張表現を根絶。
- 🧩 **顔の7領域パーツ語彙集**: 目・眉・唇・鼻・顎/喉・額・頬の7部位の微小動作を体系化、中英対照および感情・強度タグを提供。
- 📊 **4段階表情強度体系**: L1 控えめ → L2 抑制（デフォルト推奨） → L3 露骨 → L4 爆発 の強弱設定と段階的移行ルールを確立。
- ⏱️ **2秒精度の感情アーク編成**: 表情が密なショット向けに2秒高精度タイムラインと4種のアークパターン（漸進的増加 / アンチクライマックス / 表面は静寂・内面は波乱 / ジェットコースター）を設計。
- 🎬 **微表情×カメラ・ライティング連携**: 画角・焦点距離・カメラワーク・ライティングと表情の連携ルールを追加；`cinematography.md` に微表情カメラベストプラクティスを追加。
- 🚨 **脱AIフェイク顔宣言と禁止語**: `quality-anchors.md` に脱AIフェイク顔の強制ルールを追加し、完全対称な表情・瞬時の感情切り替え・誇張されたアニメ表現を禁止。
